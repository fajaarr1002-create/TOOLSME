...
def main():
    print('')
    print("\033[1;31m[1] \033[1;33mInstall pkg Termux\033[1;31m(termux)")
    time.sleep(0.3)
#________________
    print("\033[1;31m[2] \033[1;33mInstall metasploit\033[1;31m(termux)")
    time.sleep(0.3)
#__________________
    print("\033[1;31m[3] \033[1;33mInstall ngrok\033[1;31m(termux,kali)")
    time.sleep(0.3)
#___________________
    print("\033[1;31m[4] \033[1;33mEncrypt tools\033[1;31m(termux)")
    time.sleep(0.3)
#____________________
    print('\033[1;31m[5] \033[1;33mscript metesploit\033[1;31m(termux,kali)')
    time.sleep(0.3)
#____________________
    print("\033[1;31m[6] \033[1;33mEvil-Droid\033[1;31m(kali)")
    time.sleep(0.3)
#______________________
    print("\033[1;31m[7] \033[1;33mnexphisher\033[1;31m(termux,kali)")
    time.sleep(0.3)
#______________________
    print("\033[1;31m[8] \033[1;33msqlmap\033[1;31m(termux,kali)")
    time.sleep(0.3)
#_______________________
    print("\033[1;31m[9] \033[1;33mnikto\033[1;31m(termux,kali)")
    time.sleep(0.3)
#________________________
    print("\033[1;31m[10] \033[1;33mnmap\033[1;31m(termux,kali)")
    time.sleep(0.3)
#___________________________
    print("\033[1;31m[11] \033[1;33mnethunter kali\033[1;31m(termux)")
    time.sleep(0.3)
...
#___________________________
    ...
    time.sleep(0.3)
#______________________________________
    print('\033[1;31m[12] \033[1;33m Ip_Web \033[1;31m(termux,kali) ')
    time.sleep(0.3)
#______________________________________
    print('\033[1;31m[13] \033[1;33m Dork_google \033[1;31m(termux,kali) ')
    time.sleep(0.3)
#__________________________________________
    print('\033[1;31m[14] \033[1;33m Scan Ports \033[1;31m(termux,kali) ')
    time.sleep(0.3)
#_________________________________________________________________________
    print('\033[1;31m[15] \033[1;33m apktoolfix \033[1;31m(kali) ')
    time.sleep(0.3)
main()
